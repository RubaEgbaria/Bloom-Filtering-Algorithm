error id: file:///C:/Users/rubae/IdeaProjects/bloomFiltering/src/main/scala/BloomFiltering.scala:spark.
file:///C:/Users/rubae/IdeaProjects/bloomFiltering/src/main/scala/BloomFiltering.scala
...
offset: 147
uri: file:///C:/Users/rubae/IdeaProjects/bloomFiltering/src/main/scala/BloomFiltering.scala
text:
```scala
...
import org.apache.spa@@rk.rdd.RDD
...
// saving the values into a rdd bloom filter where each value has a (true | false) whether it  exists or does not.
    ...
    val input = StdIn.readLine().toInt // data.head
    // hashing the input
